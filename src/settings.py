...
##################################
PROJECT_NAME: str = "OD-WeaponDetection: Sohas Classification"
PROJECT_NAME_FULL: str = "OD-WeaponDetection: Sohas Classification"
...
PREVIEW_IMAGE_ID: int = 7504907
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/od-weapon-detection-sohas-classification"
...
SLYTAGSPLIT: Optional[Dict[str, Union[List[str], str]]] = {"classification image sets":["knive", "pistol", "smartphone", "wallet", "banknote", "credit_card"]}
